...
namespace EnviosAliExpressCore.Clases
{
    public class Fedex : IEmpresa
    {
        ...
        public Fedex(IMediosTransporte medioTransporte, ICalculadorMargenUtilidadCosto CalculadorMargenUtilidadCosto, List<Medios> lstMedios, ParametrosDTO parametrosFinal)
        {
