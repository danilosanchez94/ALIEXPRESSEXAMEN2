...
namespace EnviosAliExpressCore.Clases
{
    public class Estafeta : IEmpresa
    {
        ...
        public Estafeta(IMediosTransporte medioTransporte, ICalculadorMargenUtilidadCosto CalculadorMargenUtilidadCosto, List<Medios> lstMedios, ParametrosDTO parametrosFinal)
        {
